        ...
        options: {
            ...
            destroy: function (e, data) {
                ...
                if (data.url) {
					...
					//data.url = data.url+'&action=cbxwpsimpleaccounting_delete_attachments'+'&security='+cbxwpsimpleaccounting_attachments.nonce+'&log_id='+cbxwpsimpleaccounting_attachments.log_id;
					data.url = data.url+'&security='+cbxwpsimpleaccounting_attachments.nonce+'&log_id='+cbxwpsimpleaccounting_attachments.log_id;
                    data.dataType = data.dataType || that.options.dataType;
                    $.ajax(data).done(function () {
						$this_back.removeClass('fileupload-processing');
                        removeNode();
