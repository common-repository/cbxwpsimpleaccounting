<?php
	 ...
	 */
	if ( ! class_exists( 'CBXWPSimpleaccounting_Settings_API2' ) ):

		class CBXWPSimpleaccounting_Settings_API2 {
			...
			function callback_multiselect( $args ) {
				...
				if($args['placeholder'] == '') $args['placeholder'] = esc_html__( 'Please Select', 'cbxwpsimpleaccounting' );
